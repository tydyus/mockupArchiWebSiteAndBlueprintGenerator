const carrousels = document.getElementsByClassName("carrousel") as HTMLCollectionOf<HTMLElement>;
let AllVignettes: Array<HTMLCollectionOf<HTMLElement>> = [];
// init carrousel
const initCarrousel = () => {
for (let iCarrousel = 0; iCarrousel < carrousels.length; iCarrousel++) {
    
    const vignettes = carrousels[iCarrousel].getElementsByClassName("vignette") as HTMLCollectionOf<HTMLElement>;
